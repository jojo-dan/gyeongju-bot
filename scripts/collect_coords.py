...
KNOWN_COORDS: dict[str, dict] = {
    ...
    "복길 경주본점": {
        "lat": 35.8343,
        "lng": 129.2120,
        "address": "경주시 첨성로 71 (황남동 326-2)",
        "note": "주소 확인 (다이닝코드), 좌표는 첨성로 기반 추정. 수리산 정식점 대체",
    },
    "향화정": {
    ...
    "교동쌈밥": {
        "lat": 35.8343,
        "lng": 129.2128,
        "address": "경주시 첨성로 77 (별채반 교동쌈밥)",
        "note": "주소 확인 (다이닝코드/트리플), 좌표는 추정",
    },
    "경주원조콩국": {
    ...
    "정수가성": {
        "lat": 35.8100,
        "lng": 129.3042,
        "address": "경주시 보불로 318 (하동 335-3)",
        "note": "주소 확인 (식신/다이닝코드), 좌표는 추정",
    },
    "전주시골밥상": {
        "lat": 35.7900,
        "lng": 129.3310,
        "address": "경주시 불국신택지7길 10 (진현동 71-10)",
        "note": "주소 확인 (다이닝코드), 좌표는 추정",
    },
    "경주시락국밥": {
        "lat": 35.7890,
        "lng": 129.3310,
        "address": "경주시 영불로 37 1층",
        "note": "주소 확인 (다이닝코드/블로그), 좌표는 영불로 기반 추정. 불국사 인근 곰탕집 대체",
    },
    "산드레": {
    ...
    "바다속해물": {
        "lat": 35.8420,
        "lng": 129.2250,
        "address": "경주시 동천로93번길 4 (동천동 784-10)",
        "note": "주소 확인 (다이닝코드/트리플), 좌표는 추정",
    },
    "하연지": {
    ...
    "설월당": {
        ...
        "note": "주소 확인 (블로그/관광포털), 좌표는 추정",
    },
    "청수당 경주": {
        "lat": 35.8342,
        "lng": 129.2138,
        "address": "경주시 첨성로81번길 21-1",
        "note": "주소 확인 (다이닝코드/트리플/당근), 좌표는 추정",
    },
    "올리브": {
    ...
    "바실라(Basilla)": {
        ...
        "note": "주소 확인 (visitkorea/식신/다이닝코드), 좌표는 추정",
    },
    "카페 메이플": {
    ...
    "내류사": {
        "lat": 35.7870,
        "lng": 129.3300,
        "address": "경주시 영불로 263-7 (진현동)",
        "note": "주소 확인 (visitkorea/인스타그램), 좌표는 추정",
    },
    "아덴(Aden)": {
